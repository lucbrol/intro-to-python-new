...
def a_is_less_than_b(a, b):
  ...
  return a < b # "< " less than operator <= less than or equal to operator  
...
def a_is_greater_than_b(a, b):
  return a > b # greater than operator ">=" greater than or equal to operator
  pass
