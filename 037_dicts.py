...
my_dictionary = {
  ...
  "Dictionary": "A collection of keys mapped to values"  # create new key"Dictionary" with a value
}
...
print("" + my_dictionary["Dictionary"] )  # print key and value from the dictionary my_dictionary
# ...
