...
def get_last_item(the_list):
  return the_list[-1]# Return the last item of the list
...
def get_nth_item(the_list, n):
  return the_list[n] # Return the item of the list at the specified index
...
def get_items_between_one_and_three(the_list):
  return the_list[1:3]# Return the section of the list between indexes one
  # and three
