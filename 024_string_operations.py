...
def make_uppercase(string):
  return string.upper() # Return the string in uppercase
...
def make_lowercase(string):
  return string.lower() # Return the string in lowercase
...
def strip_whitespace(string):
  return string.strip()# Return the string with any whitespace removed from
  # the start and end
